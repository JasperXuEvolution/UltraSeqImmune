...
#SBATCH --job-name=Immunoediting_MIvsNI_Normal_R10000_gRNA
...
--a1 "$BT_ANALYSIS/Output_data/Normal_Method/Immunoediting_MI_BT_NormalMethod_KTC_N100_R10000_gRNA_intermediate" \
--a2 gRNA \
