...
#SBATCH --job-name=Immunoediting_HIvsNI_Normal_R10000_gene
...
--a1 "$BT_ANALYSIS/Output_data/Normal_Method/Immunoediting_HI_BT_NormalMethod_KTC_N100_R10000_gene_intermediate" \
