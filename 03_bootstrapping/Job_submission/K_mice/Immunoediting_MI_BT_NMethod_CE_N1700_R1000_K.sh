...
#SBATCH --job-name=Immunoediting_MI_BT_NMethod_CE_N1700_R10000_K
...
--a2 1700 --a3 100 --a4 10000 --a5 KT --a6 KT --a7 10 \
--o1 "$BT_ANALYSIS/Output_data/K_mice/Immunoediting_MI_BT" \
--o2 "$BT_ANALYSIS/Output_data/K_mice/Immunoediting_MI_BT" \
