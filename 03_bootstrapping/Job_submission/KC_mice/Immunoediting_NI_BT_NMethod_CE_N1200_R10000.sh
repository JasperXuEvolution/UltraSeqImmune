...
#SBATCH --job-name=Immunoediting_NI_BT_NMethod_CE_N1200_R10000.sh
...
--a2 1200 --a3 100 --a4 10000 --a5 KTC --a6 KT --a7 10 \
--o1 "$BT_ANALYSIS/Output_data/Normal_Method/Immunoediting_NI_BT" \
--o2 "$BT_ANALYSIS/Output_data/Normal_Method/Immunoediting_NI_BT" \
